...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>WELCOME TO<Color=/>"):Display()
    wait(.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>NANO HUB👑!!!!<Color=/>"):Display()
    wait(.14)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "Nano Hub", HidePremium = false, IntroText = "Nano Library", SaveConfig = true, ConfigFolder = "Nano Hub"})
...
OrionLib:MakeNotification({
	Name = "Nano Hub",
	Content = "Nano Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
...
W:AddLabel("Script By THUANSCRIPT")

local Section = W:AddSection({
    Name = "Update"
})

W:AddLabel("[+] Nano Hub is back!")
W:AddLabel("[+] I Not Skidder!")
W:AddLabel("[+] I Will Win!!!")
